                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="categoryname" class="form-control @error('categoryname') is-invalid @enderror" name="categoryname" value="{{ $category->nama_kategori }}" placeholder="Enter Category Name">
                                        @error('categoryname')
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="slug" class="form-control @error('slug') is-invalid @enderror" name="slug" value="{{ $category->slug }}" placeholder="Enter Keyword Category">
                                        @error('slug')
                                            <div class="text-danger"><small>{{ $message }}</small></div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="totalproduct" class="form-control @error('totalproduct') is-invalid @enderror" name="totalproduct" value="{{ $category->jumlah_product }}" placeholder="Enter Total Product">
                                        @error('totalproduct')
                                            <div class="text-danger"><small>{{ $message }}</small></div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="categoryphoto">Change Photo Category</label>
                                        <div class="value">
                                            <div class="input-group js-input-file">
                                                ...
                                                <span class="input-file__info mt-beda">{{ $category->img_category_original }}</span>
                                            </div>
                                            <div>
                                                @error('categoryphoto')
                                                    <div class="text-danger"><small>{{ $message }}</small></div>
