                    ...
                    <div class="card-body">
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="productname" class="form-control @error('productname') is-invalid @enderror" name="productname" value="{{ old('productname') }}" placeholder="Enter Product Name">
                                            @error('productname')
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="productprice" class="form-control @error('productprice') is-invalid @enderror" name="productprice" value="{{ old('productprice') }}" placeholder="Enter Product Price">
                                            @error('productprice')
                                                <div class="text-danger"><small>{{ $message }}</small></div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="categoryproduct" class="form-control @error('categoryproduct') is-invalid @enderror" id="categoryproduct">
                                                ...
                                                @foreach ($categorie as $kategori)
                                                    <option value="{{ $kategori->id}}" {{ old('categoryproduct') == $kategori->id ? 'selected' : '' }}>{{ $kategori->nama_kategori }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="productphoto">Add Photo Product</label>
                                            <div class="value">
